...
int main(){
	...
	pFileOut = fopen("resultados_as_graph_lista.txt", "a");
	...
	fprintf(pFileOut, "Análise do grafo com Lista de Adjacência:\n\n");
	...
	fprintf(pFileOut, "Construindo Lista de Adjacência (%.0lf ms)\n\n", duracao);
